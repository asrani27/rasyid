...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <form class="form-horizontal" method="post" action="/superadmin/nikah/edit/{{$data->id}}">
                @csrf
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nik_pria" value="{{$data->nik_pria}}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Nama Pria</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nama_pria" value="{{$data->nama_pria}}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">NIK Wanita</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nik_wanita" value="{{$data->nik_wanita}}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Nama Wanita</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nama_wanita" value="{{$data->nama_wanita}}" required>
                        </div>
                    </div>
                </div>
                <!-- /.box-body -->
