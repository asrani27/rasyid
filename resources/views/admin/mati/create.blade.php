...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <form class="form-horizontal" method="post" action="/superadmin/mati/create">
                @csrf
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nik_meninggal" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Nama Yang Meninggal</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nama_meninggal" required>
                        </div>
                    </div>
                    <div class="form-group">
